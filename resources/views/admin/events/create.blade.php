...
@section('content')
    ...
    <div class="content">
        <!-- BEGIN: Top Bar -->
        @include('admin.layouts.topbar', ['title' => 'Create Events'])
        <!-- END: Top Bar -->
                                ...
                                <div class="sm:grid grid-cols-3 gap-2">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="ordinary_member_price" placeholder="0.00"
                                               aria-describedby="input-group-3" value="{{ old('ordinary_member_price') }}">
                                    </div>
                                    <div class="input-group mt-2 sm:mt-0">
                                        ...
                                        <input type="text" class="form-control" name="trainee_member_price" placeholder="0.00"
                                               aria-describedby="input-group-4" value="{{ old('trainee_member_price') }}">
                                    </div>
                                    <div class="input-group mt-2 sm:mt-0">
                                        ...
                                        <input type="text" class="form-control" name="associate_member_price" placeholder="0.00"
                                               aria-describedby="input-group-5" value="{{ old('associate_member_price') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="mt-3">
                    ...
                    <div class="intro-y box p-5">
                        <div class="mt-3">
                            ...
                            <input type="text" required class="datepicker form-control" id="post-form-2"
                                   data-single-mode="true" name="date" readonly value="{{ old('date') }}">
                        </div>
                        <div class="mt-3">
                            ...
                            <select required data-placeholder="Select Category" class="tom-select w-full" name="category"
                                ...
                                <option value="c" {{ old('category') === 'c' ? 'selected' : '' }}>Conference</option>
                                <option value="w" {{ old('category') === 'w' ? 'selected' : '' }}>Webinar</option>
                            </select>
                        </div>
                        <div class="mt-5">
                            <input name="image" required id="fileInput" type="file" value="{{ old('image') }}" />
                        </div>
