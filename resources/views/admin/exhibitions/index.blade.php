...
@section('content')
    ...
    <div class="content">
        <!-- BEGIN: Top Bar -->
        @include('admin.layouts.topbar', ['title' => 'Exhibitions' ])
        <!-- END: Top Bar -->
        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <a href="{{ route('admin.exhibitions.create') }}" class="btn btn-primary shadow-md mr-2">Add New Exhibitions</a>
                <div class="dropdown">
                    <button class="dropdown-toggle btn px-2 box" aria-expanded="false" data-tw-toggle="dropdown">
                        <span class="w-5 h-5 flex items-center justify-center"> <i class="w-4 h-4"
                                                                                   data-lucide="plus"></i> </span>
                    </button>
                    @include('admin.layouts.export', ['type' => 'exhibitions'])
                </div>
            ...
            <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                ...
                <div class="card">
                    @include('admin.exhibitions.table')
                </div>
            </div>
            <!-- END: Data List -->
            <!-- BEGIN: Pagination -->
