                            ...
                            <table border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <h2></h2>
                                        ...
                                        <p>We hope this email finds you well. We are excited to confirm your registration for the upcoming {{ optional(optional($data)['event'])['title'] }}, which is scheduled to take place on {{ optional(optional($data)['event'])['date'] }} at {{ optional(optional($data)['event'])['location'] }}. We have received your payment and can confirm the successful transaction.</p>
                                        ...
                                        <ul>
                                            <li>Event Name: {{ optional(optional($data)['event'])['title'] }}</li>
                                            <li>Event Date: {{ optional(optional($data)['event'])['date'] }}</li>
                                            <li>Event Venue: {{ optional(optional($data)['event'])['location'] }}</li>
                                        </ul>
                                        ...
                                        @else
                                            <ul>
                                                <li>No hotel bookings</li>
                                            </ul>
                                        @endif

                                        <p>Your commitment and participation in this event are greatly appreciated. We're looking forward to providing you with a valuable and engaging experience. Should you have any questions or require further assistance, please don't hesitate to contact our support team at {{ config('pan.phone_number') }} or {{ config('pan.email') }}.</p>

                                        <p>Thank you once again for choosing to be a part of {{ optional(optional($data)['event'])['title'] }}. We're eager to welcome you and make this event a memorable one.</p>
