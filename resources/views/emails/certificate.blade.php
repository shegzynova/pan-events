                            ...
                            <table border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="font-family: 'DM Sans', sans-serif; font-size: 14px; vertical-align: top;">
                                        ...
                                        <p>We hope this email finds you well. please find attached your certificate of attendance for {{ $event }}</p>

                                        <p>Thank you once again for choosing to be a part of {{ $event }}.</p>
