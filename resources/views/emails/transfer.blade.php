                            ...
                            <table border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <h2></h2>
                                        ...
                                        <p>We hope this email finds you well. We are excited to confirm your registration for the upcoming {{ optional(optional($data)['event'])['title'] }}, which is scheduled to take place on {{ optional(optional($data)['event'])['date'] }} at {{ optional(optional($data)['event'])['location'] }}. Please find below the bank account details to pay to.
                                        ...
                                        <ul>
                                            <li>Bank Name: {{ config('pan.bank_name') }}</li>
                                            <li>Account No: {{ config('pan.account_number') }}</li>
                                            <li>Account Name: {{ config('pan.account_name') }}</li>
                                        </ul>
                                        ...
                                        <h5>Please send evidence of payments to {{ config('pan.email') }}.</h5>
