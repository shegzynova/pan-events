                ...
                <div id="chats" class="tab-pane active" role="tabpanel" aria-labelledby="chats-tab">
                            ...
                            <div class="overflow-x-auto scrollbar-hidden">
                                <div class="flex mt-5">
                                    <a href="" class="w-10 mr-4 cursor-pointer">
                                        ...
                                        <div class="text-xs text-slate-500 truncate text-center mt-2">Charlize Theron</div>
                                    </a>
                                    <a href="" class="w-10 mr-4 cursor-pointer">
                                        <div class="w-10 h-10 flex-none image-fit rounded-full">
                                    ...
                                    <a href="" class="w-10 mr-4 cursor-pointer">
                                        ...
                                        <div class="text-xs text-slate-500 truncate text-center mt-2">Hugh Jackman</div>
                                    </a>
                                    <a href="" class="w-10 mr-4 cursor-pointer">
                                        <div class="w-10 h-10 flex-none image-fit rounded-full">
                                            <img alt="Midone - HTML Admin Template" class="rounded-full" src="dist/images/profile-13.jpg">
                                    ...
                                    <a href="" class="w-10 mr-4 cursor-pointer">
                                        ...
                                        <div class="text-xs text-slate-500 truncate text-center mt-2">Morgan Freeman</div>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="chat__chat-list overflow-y-auto scrollbar-hidden pr-1 pt-1 mt-4">
                        <div class="intro-x cursor-pointer box relative flex items-center p-5 ">
                            ...
                            <div class="ml-2 overflow-hidden">
                                <div class="flex items-center">
                                    <a href="javascript:;" class="font-medium">Charlize Theron</a>
                ...
                <div id="friends" class="tab-pane" role="tabpanel" aria-labelledby="friends-tab">
                    ...
                    <div class="chat__user-list overflow-y-auto scrollbar-hidden pr-1 pt-1">
                        ...
                        <div class="cursor-pointer box relative flex items-center p-5 mt-5">
                            ...
                            <div class="ml-2 overflow-hidden">
                                <div class="flex items-center"> <a href="" class="font-medium">Charlize Theron</a> </div>
                        ...
                        <div class="cursor-pointer box relative flex items-center p-5 mt-5">
                            ...
                            <div class="ml-2 overflow-hidden">
                                <div class="flex items-center"> <a href="" class="font-medium">Hugh Jackman</a> </div>
                                <div class="w-full truncate text-slate-500 mt-0.5">Last seen 2 hours ago</div>
                            </div>
                            <div class="dropdown ml-auto">
                                <a class="dropdown-toggle w-5 h-5 block" href="javascript:;" aria-expanded="false" data-tw-toggle="dropdown"> <i data-lucide="more-horizontal" class="w-5 h-5 text-slate-500"></i> </a>
