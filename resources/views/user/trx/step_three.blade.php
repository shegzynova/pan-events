        ...
        <div class="intro-y box overflow-hidden mt-5">
                ...
                <div class="overflow-x-auto">
                    <table class="table">
                        ...
                        @php
                            ...
                            $total_price = $event_price + $hotel_price;
                        ...
                        <tr>
                            <td class="border-b dark:border-darkmode-400">
                                <div class="font-medium whitespace-nowrap">Hotel</div>
                        ...
                        @endif
                        @if(!is_null(optional($data)['exhibition']))
                        <tr>
                            <td class="border-b dark:border-darkmode-400">
            ...
            <div class="px-5 sm:px-20 pb-10 sm:pb-20 sm:pt-20 flex flex-col-reverse sm:flex-row">
                <div class="text-center sm:text-left mt-10 sm:mt-0">
                    <div class="text-base text-slate-500 mb-6">Payment Method</div>
                    <div class="mt-1"><img width="200px" src="{{ asset('dist/images/1600px-Paystack_Logo.png') }}"></div>
                    <div class="text-right mt-5">
                        <a href="{{ route('user.startPayment') }}" class="btn btn-primary w-64">PAY</a>
                    </div>
                </div>
                <div class="text-center sm:text-right sm:ml-auto">
                    <div class="text-base text-slate-500">Total Amount</div>
                    <div class="text-xl text-primary font-medium mt-2">₦{{ $total_price }}</div>
                </div>
            </div>
